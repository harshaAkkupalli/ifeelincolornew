...
export default function ClinicianAppShell() {
  ...
  return (
    ...
    >
      ...
      {/* Bottom Tab Bar — bouncy squircle tabs with emerald active state */}
      <nav
        className="fixed bottom-0 left-0 right-0 z-40 px-3 pt-2"
        style={{
          background: 'rgba(255,255,255,0.94)',
          backdropFilter: 'blur(18px)',
          borderTop: '1px solid rgba(31,111,84,0.10)',
          boxShadow: '0 -8px 32px rgba(31,111,84,0.08)',
          ...
          {TABS.map((t) => {
            ...
            return (
              <li key={t.to} className="flex-1">
                <InfoTip text={t.tip} side="top" asChild>
                  <button
                  ...
                  >
                    ...
                    <span
                      className="text-[10px] font-nunito font-semibold"
